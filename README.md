...
如果您想访问线上版本，可以点击此ip链接**http://42.192.41.168:8083/#/index** **PS：域名挂掉了，只能通过ip方式进行访问。:(**

**注意:该项目仅支持移动端访问，PC端访问会出现样式不适配的问题。**

## 项目介绍:
之所以是写了这个项目是因为最近看到的太多的地狱笑话，笑多了怕有损功德。网上也看到了有人做的同样的应用，于是自己弄了一个网页版的电子木鱼，**无需下载安装，无需收集任何用户权限以及用户隐私.**
